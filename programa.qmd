...
| | [S1: Modelos de lenguaje N-gram y Regla de la Cadena](slides/semana03/s1_ngram_lm.qmd) | |
| | [S2: Evaluación: Perplejidad y técnicas de Suavizado](slides/semana03/s2_perplejidad_suavizado.qmd) | Quiz 3 |
| | [S3: Modelos Ocultos de Markov (HMM) para etiquetado POS](slides/semana03/s3_hmm_pos.qmd) | |
| **4** | **La Revolución Vectorial** | |
| | [S1: Word2Vec: Skip-gram y CBOW](slides/semana04/s1_word2vec.qmd) | |
| | [S2: GloVe y FastText (embeddings de subpalabras)](slides/semana04/s2_glove_fasttext.qmd) | |
| | [S3: Visualización de datos de alta dimensión (t-SNE y PCA)](slides/semana04/s3_visualizacion.qmd) | **📝 Tarea 1:** Analizador de sentimiento usando TF-IDF + Regresión Logística |
| **5** | **Redes Neuronales para NLP** | |
| | [S1: Repaso de Perceptrones y Retropropagación](slides/semana05/s1_perceptron_backprop.qmd) | |
| | [S2: Perceptrones Multicapa para Clasificación de Texto](slides/semana05/s2_mlp_clasificacion.qmd) | Quiz 4 |
| | [S3: Variantes de Descenso de Gradiente y Regularización (Dropout)](slides/semana05/s3_optimizacion_regularizacion.qmd) | |
| **6** | **Redes Neuronales Recurrentes (RNNs)** | |
| | [S1: Arquitectura RNN: Manejando longitud variable](slides/semana06/s1_arquitectura_rnn.qmd) | |
| | [S2: Gradientes que desaparecen y la solución LSTM](slides/semana06/s2_lstm_vanishing_gradients.qmd) | Quiz 5 |
| | [S3: Unidades Recurrentes con Compuertas (GRU) y RNNs Bidireccionales](slides/semana06/s3_gru_bidireccional.qmd) | |
| **7** | **Secuencia a Secuencia (Seq2Seq)** | |
| | [S1: Arquitecturas Codificador-Decodificador](slides/semana07/s1_seq2seq_encoder_decoder.qmd) | |
| | [S2: Aplicaciones: Traducción Automática Neuronal (NMT)](slides/semana07/s2_nmt_traduccion.qmd) | |
| | [S3: El problema del "cuello de botella" y el nacimiento de la **Atención**](slides/semana07/s3_atencion.qmd) | |
| **8** | **Redes Neuronales Convolucionales para NLP** | |
| | [S1: Convoluciones 1D para texto](slides/semana08/s1_conv1d_texto.qmd) | |
| | [S2: Max Pooling Global vs. Local](slides/semana08/s2_pooling.qmd) | Quiz 6 |
| | [S3: Comparación RNNs vs. CNNs para clasificación](slides/semana08/s3_rnn_vs_cnn.qmd) | **📝 Tarea 2:** Generador de nombres a nivel de caracteres con LSTM |
| **9** | **Auto-Atención & Transformers** | |
| | [S1: Atención de Producto Escalar (Queries, Keys, Values)](slides/semana09/s1_atencion_producto_escalar.qmd) | |
| | [S2: Atención Multi-Cabeza y Codificación Posicional](slides/semana09/s2_multihead_posicional.qmd) | |
| | [S3: El bloque Transformer completo (Residuales, Normalización)](slides/semana09/s3_transformer_completo.qmd) | |
