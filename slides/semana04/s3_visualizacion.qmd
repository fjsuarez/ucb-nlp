...
1. **Solo captura relaciones lineales**
   - No puede "desdoblar" variedades (manifolds) no lineales

2. **Optimiza varianza global**
   - Puede sacrificar estructura local por preservar distancias grandes

3. **Sensible a outliers**
   - Un punto muy lejano puede distorsionar toda la proyección

:::
::: {.column width="50%"}

### Ejemplo: El problema del "Swiss Roll"

Datos en 3D enrollados como un brazo de gitano. PCA los aplasta:
